...
// `tw` son las clases Tailwind usadas para pintar el banner de resultado en info.html.
// Antes vivían hardcodeadas (duplicadas) en un <script> dentro de info.html, junto a
// otra copia de `desc`. Ahora info.html importa este mismo RESULTS_MAP, así solo hay
// una fuente de verdad por nivel.
export const RESULTS_MAP = [
  { min: 0, max: 12, level: "Sin estrés", color: "#10b981",
    tw: { bg: "bg-emerald-50", border: "border-emerald-200", text: "text-emerald-700" },
  ...
  { min: 13, max: 36, level: "Estrés leve", color: "#eab308",
    tw: { bg: "bg-yellow-50", border: "border-yellow-200", text: "text-yellow-700" },
  ...
  { min: 37, max: 48, level: "Estrés moderado", color: "#f97316",
    tw: { bg: "bg-orange-50", border: "border-orange-200", text: "text-orange-700" },
  ...
  { min: 49, max: 60, level: "Estrés grave", color: "#ef4444",
    tw: { bg: "bg-red-50", border: "border-red-200", text: "text-red-700" },
  ...
  { min: 61, max: 72, level: "Estrés muy grave", color: "#991b1b",
    tw: { bg: "bg-red-100", border: "border-red-300", text: "text-red-900" },
